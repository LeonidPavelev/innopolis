...
COMMENT ON COLUMN orders.order_date IS 'Дата и время заказа (по умолчанию текущая дата и время)';
COMMENT ON COLUMN orders.total_amount IS 'Общая сумма заказа (обязательное поле)';
